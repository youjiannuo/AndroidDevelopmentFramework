...
public class Animation {
    ...
    public static void alpha(View view, Long delay, float from, float to, int time, ValueAnimator.AnimatorListener l) {
    ...
    public static ObjectAnimator translationY(View v, float fromY, float toY, int time, Animator.AnimatorListener l) {
    ...
    public static ObjectAnimator translationX(View v, float fromX, float toX, int time) {
        ObjectAnimator animator = ObjectAnimator
