 ...
 * hfh,七月
 */
public abstract class YNAutomaticFragment extends BaseFragment
        implements OnHttpListener, SwipeRefreshLayout.OnRefreshListener , OnSendHttpOperationListener {
...
//        }
        ...
        sendHttp(http, values);
    }


    protected void sendHttp(int http[], String values[][]) {
    ...
    protected void sendHttp(int http, String values[]) {
        sendHttp(new int[]{http}, new String[][]{values});
    }
