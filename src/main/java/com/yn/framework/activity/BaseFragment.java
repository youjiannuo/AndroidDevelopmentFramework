...
public abstract class BaseFragment extends Fragment implements
    ...
    public void setYNActivity(YNCommonActivity activity) {
        mActivity = activity;
    }

    public Activity getYNActivity() {
        return mActivity == null ? (mActivity = (YNCommonActivity) getActivity()) : mActivity;
    }
    ...
    protected void setOnClickListeners(View... vs) {
        for (View v : vs) {
    ...
    public void openNewActivity(Class cls, Object... keyAndValue) {
        ((YNCommonActivity) getContext()).openNewActivity(cls, keyAndValue);
    }
    ...
    protected <T> T findById(int resId) {
...
//            }
    ...
    protected void showRemindBox(String[] button, String message, String title, int icon, int type) {
        if (getYNActivity() == null || getYNActivity().isFinishing()) return;
