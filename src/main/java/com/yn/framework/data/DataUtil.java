...
public class DataUtil {
    ...
    public static String getMoneyString(double money) {
        ...
        StringBuilder s = new StringBuilder(result.substring(result.length() - 3, result.length()));
    ...
    public static double getMoney(String money) {
        ...
        return getDouble(result.toString());
    }
    ...
    public static int getNoZeroNum(int a, int b) {
