...
public class Http extends HttpUtils {
    ...
    public Http(Context context) {
        //        super();
        this(30000);
        configCurrentHttpCacheExpiry(0);
    }
    ...
    @Override
    public <T> HttpHandler<T> send(HttpRequest.HttpMethod method, final String url, RequestParams params, RequestCallBack<T> callBack) {
        if (params == null) {
