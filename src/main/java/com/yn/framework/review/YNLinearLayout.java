...
public class YNLinearLayout extends LinearLayout implements OnYNOperation, YNHttpOperation {
    ...
    public YNLinearLayout(Context context, AttributeSet attrs) {
        ...
        array = context.obtainStyledAttributes(attrs, R.styleable.YNLinearLayout);
        if (array.getBoolean(R.styleable.YNLinearLayout_onClickMethod, false)) {
            mYJNView.setActivityBackListener(mActivity);
        }
        array.recycle();
    }
    ...
    public void setData(Object obj) {
        ...
        if (mType == 1) {
            ...
            if (obj instanceof JSON) {
                ...
                //当前就是对象
                new YNManager(this, obj).setStartData(mPosition, this);
            }
        } else {
        ...
        mYJNView.startClick(new OnBackListener() {
            ...
            public void onHttpSuccess(View view, int position, Object data) {
                if (mOnHttpListener != null) {
                    ...
                    data = mOnHttpListener.onHttpDetailSuccess(data, YNLinearLayout.this);
                }
    ...
    public void setOnClickListener(OnClickListener l) {
        ...
        if (l != null && !mIsBackGround) {
            super.setBackgroundResource(R.drawable.yn_click);
        }
