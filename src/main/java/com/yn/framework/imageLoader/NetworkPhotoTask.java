...
//    }
    ...
    public String getPhotoKey() {
        ...
        getPhotoName();
        return key = fileName + "w" + width + "h" + height + "border" + roundedCornersSize + "rounded" + isSetRounded + "wm" + viewMaxWidth + "wh" + viewMaxHeight + "isGaussianBlur" + isGaussianBlur;
    }
    ...
    public boolean equals(Object object) {
        if (object instanceof NetworkPhotoTask) {
            ...
            return task.getPhotoKey().equals(getPhotoKey());
        }
        return false;
    }
